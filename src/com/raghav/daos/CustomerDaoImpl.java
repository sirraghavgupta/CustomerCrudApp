...
public class CustomerDaoImpl implements CustomerDao{
    ...
    public Integer createCustomer(Customer customer) {
        ...
        try {
            ps = conn.prepareStatement("insert into customer_info(full_name, " +
    ...
    public boolean deleteCustomerById(Integer id) {
        ...
        PreparedStatement ps = null;
        try {
            ps = conn.prepareStatement("delete from customer_info where id = ?");
            ps.setInt(1, id);
    ...
    public boolean updateCustomer(Customer updatedCustomer) {
        ...
        Connection conn = DBConnection.getConnection();
        try {
            ps = conn.prepareStatement("update customer_info set full_name=?, " +
    ...
    public Customer findById(Integer id) {
        ...
        Connection conn = DBConnection.getConnection();
        try {
            ps = conn.prepareStatement("select * from customer_info where id = ?");
            ps.setInt(1, id);
            rs = ps.executeQuery();
